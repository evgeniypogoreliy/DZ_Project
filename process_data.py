...
user_input = input('Введите  запись (в качестве разделителя используйте пробел): ')
key_note = int(input("В какой блолкнот внести запись? Если 'Планы', то введите цифру 1, если 'Завершённые дела', то введите цифру 2 =>  "))
...
def creating_record(string):
    if key_note == 1:
        ...
        return compl_record 
    else: print('Неверно задан номер блокнота! Введите цифру 1 Планирование дела или цифру 2 для Завершенного дела')       
